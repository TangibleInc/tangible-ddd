...
| Lane | Mechanism | When |
|------|-----------|------|
| self-publisher | `extends DomainEvent implements IIntegrationEvent, IAnnouncesIntegration { use RecordBehaviour; }` | born-scalar facts; no in-process consumer needs entities |
