...
if (!defined('TANGIBLE_DDD_VERSION')) {
    define('TANGIBLE_DDD_VERSION', '0.6.5');
}
...
// Slug: 0.6.5 → 0_6_5  (dots and hyphens → underscores)
if (!function_exists('tangible_ddd_register_0_6_5')) {

    /**
     * Register this copy (0.6.5) into Tangible_DDD_Versions.
     * Hooked at plugins_loaded priority 0 so all copies register before pri-1 wins.
     */
    function tangible_ddd_register_0_6_5(): void
    {
        // Pass a closure so the callable type check passes even when this register
        // function is invoked before tangible_ddd_initialize_0_6_5() is defined
        ...
        Tangible_DDD_Versions::instance()->register(
            ...
            static function (string $path): void {
                tangible_ddd_initialize_0_6_5($path);
            }
        );
    }

    if (function_exists('add_action')) {
        add_action('plugins_loaded', 'tangible_ddd_register_0_6_5', 0, 0);
    } else {
        ...
        tangible_ddd_register_0_6_5();
    }
}

// ─── Version-named initializer (guarded — the winner calls this) ──────────────
if (!function_exists('tangible_ddd_initialize_0_6_5')) {
     ...
     */
    function tangible_ddd_initialize_0_6_5(string $path): void
    {
