...
if (!defined('TANGIBLE_DDD_VERSION')) {
    define('TANGIBLE_DDD_VERSION', '0.2.3');
}
...
if (!class_exists('Tangible_DDD_Versions', false)) {
    ...
    class Tangible_DDD_Versions
    {
         ...
         *
         * @param string      $version      SemVer string (e.g. '0.2.3').
...
// Slug: 0.2.3 → 0_2_3  (dots and hyphens → underscores)
if (!function_exists('tangible_ddd_register_0_2_3')) {

    /**
     * Register this copy (0.2.3) into Tangible_DDD_Versions.
     * Hooked at plugins_loaded priority 0 so all copies register before pri-1 wins.
     */
    function tangible_ddd_register_0_2_3(): void
    {
        // Pass a closure so the callable type check passes even when this register
        // function is invoked before tangible_ddd_initialize_0_2_3() is defined
        ...
        Tangible_DDD_Versions::instance()->register(
            ...
            static function (string $path): void {
                tangible_ddd_initialize_0_2_3($path);
            }
        );
    }

    if (function_exists('add_action')) {
        add_action('plugins_loaded', 'tangible_ddd_register_0_2_3', 0, 0);
    } else {
        ...
        tangible_ddd_register_0_2_3();
    }
}

// ─── Version-named initializer (guarded — the winner calls this) ──────────────
if (!function_exists('tangible_ddd_initialize_0_2_3')) {
     ...
     */
    function tangible_ddd_initialize_0_2_3(string $path): void
    {
